...
('A','HSHandleLimitServiceImpl','com.icss.regieapp.casestd.holidaysconf.model.TCHandleLimit','n','(null)','com.icss.regieapp.datainterface.remoteservice.hessianservice.serviceentity.HessianPublicResponse','n','(null)','(null)','(null)'),
...
VALUES((SELECT concat (hex(RAND()), hex(RAND())) a FROM SYSIBM.SYSDUMMY1),'NationCode','10000001','当前系统烟草专卖局单位编码',(SELECT current date FROM sysibm.sysdummy1),'1');
